...
"""Commerce capability tests for merchant and menu APIs."""
...
class CommerceTest(integration_test_utils.IntegrationTestBase):
  """Tests for commerce merchant and menu endpoints."""
