...
class CheckoutRestaurantExtensionCreateRequest(RootModel[Any]):
  root: Any = Field(..., title="Checkout Restaurant Extension Create Request")
  """
    Extends checkout with menu modifier selections for restaurant ordering.
    """


class RestaurantLineItem(LineItemCreateRequest):
