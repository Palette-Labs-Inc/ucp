...
class CheckoutRestaurantExtensionUpdateRequest(RootModel[Any]):
  root: Any = Field(..., title="Checkout Restaurant Extension Update Request")
  """
    Extends checkout with menu modifier selections for restaurant ordering.
    """


class RestaurantLineItem(LineItemUpdateRequest):
