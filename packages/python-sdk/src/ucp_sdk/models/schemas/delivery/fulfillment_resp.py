...
from ..shopping.fulfillment_resp import Checkout as Checkout_1


class DeliveryFulfillmentExtensionResponse(BaseModel):
...
class Checkout(Checkout_1):
  ...
  fulfillment: Fulfillment | Fulfillment8 | None = None
