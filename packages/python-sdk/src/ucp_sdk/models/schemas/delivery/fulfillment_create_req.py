...
from ..shopping.fulfillment_create_req import Checkout as Checkout_1


class DeliveryFulfillmentExtensionCreateRequest(BaseModel):
...
class Checkout(Checkout_1):
  ...
  fulfillment: Fulfillment | Fulfillment2 | None = None
