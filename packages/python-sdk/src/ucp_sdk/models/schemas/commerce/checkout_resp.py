...
class CheckoutMenuModifiersExtensionResponse(RootModel[Any]):
  root: Any = Field(..., title="Checkout Menu Modifiers Extension Response")
  """
    Extends checkout with menu modifier selections for commerce ordering.
    """


class CommerceLineItem(LineItemResponse):
