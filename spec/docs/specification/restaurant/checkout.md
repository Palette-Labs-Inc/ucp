...
* **Capability Name:** `xyz.localprotocol.restaurant.checkout`
* **Version:** `2026-01-11`
...
{{ schema_fields('checkout_resp', 'restaurant/checkout') }}
...
{{ method_fields('create_checkout', 'restaurant/rest.openapi.json', 'restaurant/checkout') }}
...
{{ method_fields('get_checkout', 'restaurant/rest.openapi.json', 'restaurant/checkout') }}
...
{{ method_fields('update_checkout', 'restaurant/rest.openapi.json', 'restaurant/checkout') }}
...
{{ method_fields('complete_checkout', 'restaurant/rest.openapi.json', 'restaurant/checkout') }}
...
{{ method_fields('cancel_checkout', 'restaurant/rest.openapi.json', 'restaurant/checkout') }}
...
{{ schema_fields('types/item.create_req', 'restaurant/checkout') }}

#### Item Update Request

{{ schema_fields('types/item.update_req', 'restaurant/checkout') }}

#### Item Response

{{ schema_fields('types/item_resp', 'restaurant/checkout') }}

### Line Item

#### Line Item Create Request

{{ schema_fields('types/line_item.create_req', 'restaurant/checkout') }}

#### Line Item Update Request

{{ schema_fields('types/line_item.update_req', 'restaurant/checkout') }}

#### Line Item Response

{{ schema_fields('types/line_item_resp', 'restaurant/checkout') }}

### Link

{{ schema_fields('types/link', 'restaurant/checkout') }}
...
{{ schema_fields('message', 'restaurant/checkout') }}

### Message Error

{{ schema_fields('types/message_error', 'restaurant/checkout') }}

### Message Info

{{ schema_fields('types/message_info', 'restaurant/checkout') }}

### Message Warning

{{ schema_fields('types/message_warning', 'restaurant/checkout') }}

### Payment

#### Payment Create Request

{{ schema_fields('payment.create_req', 'restaurant/checkout') }}

#### Payment Update Request

{{ schema_fields('payment.update_req', 'restaurant/checkout') }}

#### Payment Response

{{ schema_fields('payment_resp', 'restaurant/checkout') }}

### Payment Handler Response

{{ schema_fields('types/payment_handler_resp', 'restaurant/checkout') }}

### Payment Instrument

{{ schema_fields('payment_instrument', 'restaurant/checkout') }}

### Card Payment Instrument

{{ schema_fields('card_payment_instrument', 'restaurant/checkout') }}

### Payment Credential

{{ schema_fields('payment_credential', 'restaurant/checkout') }}

### Token Credential Response

{{ schema_fields('token_credential.create_req', 'restaurant/checkout') }}

### Card Credential

{{ schema_fields('card_credential', 'restaurant/checkout') }}

### Postal Address

{{ schema_fields('postal_address', 'restaurant/checkout') }}

### Response

{{ extension_schema_fields('capability.json#/$defs/response', 'restaurant/checkout') }}

### Total

#### Total Response

{{ schema_fields('types/total_resp', 'restaurant/checkout') }}

### UCP Response Checkout

{{ extension_schema_fields('ucp.json#/$defs/response_checkout', 'restaurant/checkout') }}

### Order Confirmation

{{ schema_fields('order_confirmation', 'restaurant/checkout') }}
