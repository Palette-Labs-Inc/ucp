...
* **Capability Name:** `xyz.localprotocol.restaurant.merchant`
* **Version:** `DRAFT`
...
* **Merchant**: A business entity available for discovery and restaurant, with
...
{{ method_fields('search_merchants', 'restaurant/rest.openapi.json', 'restaurant/merchant') }}
...
{{ method_fields('get_merchant', 'restaurant/rest.openapi.json', 'restaurant/merchant') }}
...
{{ extension_schema_fields('restaurant/merchant.json#/$defs/context', 'restaurant/merchant') }}

### Merchant

{{ schema_fields('restaurant/types/merchant', 'restaurant/merchant') }}

### Media

{{ schema_fields('shopping/types/media', 'restaurant/merchant') }}
...
{{ schema_fields('restaurant/types/merchant_search_filters', 'restaurant/merchant') }}
...
{{ extension_schema_fields('shopping/types/pagination.json#/$defs/request', 'restaurant/merchant') }}

#### Pagination Response

{{ extension_schema_fields('shopping/types/pagination.json#/$defs/response', 'restaurant/merchant') }}
...
{{ schema_fields('shopping/types/message_error', 'restaurant/merchant') }}

#### Message (Warning)

{{ schema_fields('shopping/types/message_warning', 'restaurant/merchant') }}

#### Message (Info)

{{ schema_fields('shopping/types/message_info', 'restaurant/merchant') }}
