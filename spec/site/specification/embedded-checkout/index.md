...
The address object uses the UCP [PostalAddress](/specification/shopping/checkout/#postal-address) format:
...
| Name          | Type                                                                       | Required | Description                                                                                                                                  |
| ------------- | -------------------------------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| ucp           | [Ucp Response Order](/specification/shopping/order/#ucp-response-order)    | **Yes**  |                                                                                                                                              |
...
| line_items    | Array\[[Order Line Item](/specification/shopping/order/#order-line-item)\] | **Yes**  | Immutable line items — source of truth for what was ordered.                                                                                 |
| fulfillment   | object                                                                     | **Yes**  | Fulfillment data: buyer expectations and what actually happened.                                                                             |
| adjustments   | Array\[[Adjustment](/specification/shopping/order/#adjustment)\]           | No       | Append-only event log of money movements (refunds, returns, credits, disputes, cancellations, etc.) that exist independently of fulfillment. |
| totals        | Array\[[Total Response](/specification/shopping/order/#total-response)\]   | **Yes**  | Different totals for the order.                                                                                                              |
