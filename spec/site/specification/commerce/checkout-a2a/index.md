...
This document specifies the Agent2Agent Protocol (A2A) binding for [Checkout Capability](https://ucp.dev/specification/commerce/checkout/index.md).
...
When negotiating `xyz.localprotocol.commerce.checkout`, the checkout payload includes menu modifier selections on line items (`line_items[].modifier_selections`), using the commerce modifier selection type.
