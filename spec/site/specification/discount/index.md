...
| applied | Array\[[Applied Discount](/specification/discount/#applied-discount)\] | No       | Discounts successfully applied (code-based and automatic).                                                 |
...
| allocations | Array\[[Discount Allocation](/specification/discount/#discount-allocation)\] | No       | Breakdown of where this discount was allocated. Sum of allocation amounts equals total amount.                                   |
