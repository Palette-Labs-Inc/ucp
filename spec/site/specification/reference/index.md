...
| allocations | Array\[[Discount Allocation](/specification/reference/#discount-allocation)\] | No       | Breakdown of where this discount was allocated. Sum of allocation amounts equals total amount.                                   |
...
| Name | Type                                     | Required | Description                 |
| ---- | ---------------------------------------- | -------- | --------------------------- |
| min  | [Price](/specification/reference/#price) | **Yes**  | Minimum price in the range. |
| max  | [Price](/specification/reference/#price) | **Yes**  | Maximum price in the range. |
...
| price       | [Price Range](/specification/reference/#price-range)                | **Yes**  | Price range across all variants.                                                                   |
| list_price  | [Price Range](/specification/reference/#price-range)                | No       | List price range before discounts (for strikethrough display).                                     |
| media       | Array\[[Media](/specification/reference/#media)\]                   | No       | Product media (images, videos, 3D models). First item is the featured media for listings.          |
| options     | Array\[[Product Option](/specification/reference/#product-option)\] | No       | Product options (Size, Color, etc.).                                                               |
| variants    | Array\[[Variant](/specification/reference/#variant)\]               | **Yes**  | Purchasable variants of this product. First item is the featured variant for listings.             |
| rating      | [Rating](/specification/reference/#rating)                          | No       | Aggregate product rating.                                                                          |
...
| values | Array\[[Option Value](/specification/reference/#option-value)\] | **Yes**  | Available values for this option.    |
...
| price    | [Price Filter](/specification/reference/#price-filter) | No       |                                                                                                                                                                                                                                                             |
...
| category         | string                                                                | No       | Category: taxonomy path (e.g., 'Apparel > Shirts') or merchant-defined type (e.g., 'Premium Tee'). |
| price            | [Price](/specification/reference/#price)                              | **Yes**  | Current selling price.                                                                             |
| list_price       | [Price](/specification/reference/#price)                              | No       | List price before discounts (for strikethrough display).                                           |
| availability     | object                                                                | No       | Variant availability for purchase.                                                                 |
| selected_options | Array\[[Selected Option](/specification/reference/#selected-option)\] | No       | Option selections that define this variant.                                                        |
| media            | Array\[[Media](/specification/reference/#media)\]                     | No       | Variant media (images, videos, 3D models). First item is the featured media for listings.          |
| rating           | [Rating](/specification/reference/#rating)                            | No       | Variant rating.                                                                                    |
...
*Handler schema directory not found: spec/source/handlers*
...
| capabilities | Array\[[Capability Discovery](/specification/reference/#capability-discovery)\] | **Yes**  | Supported capabilities and extensions.     |
...
| ------------ | ----------------------------------------------------------------------------- | -------- | ------------------------------------------ |
| version      | string                                                                        | **Yes**  | UCP protocol version in YYYY-MM-DD format. |
| capabilities | Array\[[Capability Response](/specification/reference/#capability-response)\] | **Yes**  | Active capabilities for this response.     |
