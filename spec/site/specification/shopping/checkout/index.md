...
> **Note:** Checkout permalinks are a REST-specific construct that extends the [REST transport binding](https://ucp.dev/specification/shopping/checkout-rest/index.md). Accessing a permalink returns a redirect to the checkout UI or renders the checkout page directly.
...
| ------------ | ----------------------------------------------------------------------------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ucp          | [Ucp Response Checkout](/specification/shopping/checkout/#ucp-response-checkout)    | **Yes**  |                                                                                                                                                                                                                                                                 |
| id           | string                                                                              | **Yes**  | Unique identifier of the checkout session.                                                                                                                                                                                                                      |
| line_items   | Array\[[Line Item Response](/specification/shopping/checkout/#line-item-response)\] | **Yes**  | List of line items being checked out.                                                                                                                                                                                                                           |
| buyer        | [Buyer](/specification/shopping/checkout/#buyer)                                    | No       | Representation of the buyer.                                                                                                                                                                                                                                    |
...
| totals       | Array\[[Total Response](/specification/shopping/checkout/#total-response)\]         | **Yes**  | Different cart totals.                                                                                                                                                                                                                                          |
| messages     | Array\[[Message](/specification/shopping/checkout/#message)\]                       | No       | List of messages with error and info about the checkout session state.                                                                                                                                                                                          |
| links        | Array\[[Link](/specification/shopping/checkout/#link)\]                             | **Yes**  | Links to be displayed by the platform (Privacy Policy, TOS). Mandatory for legal compliance.                                                                                                                                                                    |
...
| payment      | [Payment Response](/specification/shopping/checkout/#payment-response)              | **Yes**  |                                                                                                                                                                                                                                                                 |
| order        | [Order Confirmation](/specification/shopping/checkout/#order-confirmation)          | No       | Details about an order created for this checkout session.                                                                                                                                                                                                       |
...
| Name       | Type                                                                                            | Required | Description                           |
| ---------- | ----------------------------------------------------------------------------------------------- | -------- | ------------------------------------- |
| line_items | Array\[[Line Item Create Request](/specification/shopping/checkout/#line-item-create-request)\] | **Yes**  | List of line items being checked out. |
| buyer      | [Buyer](/specification/shopping/checkout/#buyer)                                                | No       | Representation of the buyer.          |
| currency   | string                                                                                          | **Yes**  | ISO 4217 currency code.               |
| payment    | [Payment Create Request](/specification/shopping/checkout/#payment-create-request)              | **Yes**  |                                       |
...
| id         | string                                                                                          | **Yes**  | The unique identifier of the checkout session.Defined in path. |
| id         | string                                                                                          | **Yes**  | Unique identifier of the checkout session.                     |
| line_items | Array\[[Line Item Update Request](/specification/shopping/checkout/#line-item-update-request)\] | **Yes**  | List of line items being checked out.                          |
| buyer      | [Buyer](/specification/shopping/checkout/#buyer)                                                | No       | Representation of the buyer.                                   |
| currency   | string                                                                                          | **Yes**  | ISO 4217 currency code.                                        |
| payment    | [Payment Update Request](/specification/shopping/checkout/#payment-update-request)              | **Yes**  |                                                                |
...
| ------------ | -------------------------------------------------------------------------- | -------- | -------------------------------------------------------------- |
| id           | string                                                                     | **Yes**  | The unique identifier of the checkout session.Defined in path. |
| payment_data | [Payment Instrument](/specification/shopping/checkout/#payment-instrument) | **Yes**  |                                                                |
...
- [REST Binding](https://ucp.dev/specification/shopping/checkout-rest/index.md): RESTful API mapping using standard HTTP verbs and JSON payloads.
- [MCP Binding](https://ucp.dev/specification/shopping/checkout-mcp/index.md): Model Context Protocol mapping for agentic interaction.
- [A2A Binding](https://ucp.dev/specification/shopping/checkout-a2a/index.md): Agent-to-Agent Protocol mapping for agentic interactions.
...
| totals                    | Array\[[Total Response](/specification/shopping/checkout/#total-response)\] | **Yes**  | Fulfillment option totals breakdown.                                       |
...
| Name     | Type                                                                         | Required | Description                           |
| -------- | ---------------------------------------------------------------------------- | -------- | ------------------------------------- |
| item     | [Item Create Request](/specification/shopping/checkout/#item-create-request) | **Yes**  |                                       |
...
| --------- | ---------------------------------------------------------------------------- | -------- | ------------------------------------------------------ |
| id        | string                                                                       | No       |                                                        |
| item      | [Item Update Request](/specification/shopping/checkout/#item-update-request) | **Yes**  |                                                        |
| quantity  | integer                                                                      | **Yes**  | Quantity of the item being purchased.                  |
...
| --------- | --------------------------------------------------------------------------- | -------- | ------------------------------------------------------ |
| id        | string                                                                      | **Yes**  |                                                        |
| item      | [Item Response](/specification/shopping/checkout/#item-response)            | **Yes**  |                                                        |
| quantity  | integer                                                                     | **Yes**  | Quantity of the item being purchased.                  |
| totals    | Array\[[Total Response](/specification/shopping/checkout/#total-response)\] | **Yes**  | Line item totals breakdown.                            |
| parent_id | string                                                                      | No       | Parent line item identifier for any nested structures. |
...
This object MUST be one of the following types: [Message Error](/specification/shopping/checkout/#message-error), [Message Warning](/specification/shopping/checkout/#message-warning), [Message Info](/specification/shopping/checkout/#message-info).
...
| Name                   | Type                                                                                            | Required | Description                                                                                                                                                                                                                |
| ---------------------- | ----------------------------------------------------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| handlers               | Array\[[Payment Handler Response](/specification/shopping/checkout/#payment-handler-response)\] | **Yes**  | Processing configurations that define how payment instruments can be collected. Each handler specifies a tokenization or payment collection strategy.                                                                      |
| selected_instrument_id | string                                                                                          | No       | The id of the currently selected payment instrument from the instruments array. Set by the agent when submitting payment, and echoed back by the merchant in finalized state.                                              |
| instruments            | Array\[[Payment Instrument](/specification/shopping/checkout/#payment-instrument)\]             | No       | The payment instruments available for this payment. Each instrument is associated with a specific handler via the handler_id field. Handlers can extend the base payment_instrument schema to add handler-specific fields. |
...
This object MUST be one of the following types: [Card Payment Instrument](/specification/shopping/checkout/#card-payment-instrument).
...
| billing_address       | [Postal Address](/specification/shopping/checkout/#postal-address)         | No       | The billing address associated with this payment method.                                                                                                           |
| credential            | [Payment Credential](/specification/shopping/checkout/#payment-credential) | No       |                                                                                                                                                                    |
...
This object MUST be one of the following types: [Token Credential Response](/specification/shopping/checkout/#token-credential-response), [Card Credential](/specification/shopping/checkout/#card-credential).
...
| capabilities | Array\[[Capability Response](/specification/shopping/checkout/#capability-response)\] | **Yes**  | Active capabilities for this response.     |
