...
| item      | [Item Response](/specification/shopping/order/#item-response)            | **Yes**  | Product data (id, title, price, image_url).                                                                                                                                |
| quantity  | object                                                                   | **Yes**  | Quantity tracking. Both total and fulfilled are derived from events.                                                                                                       |
| totals    | Array\[[Total Response](/specification/shopping/order/#total-response)\] | **Yes**  | Line item totals breakdown.                                                                                                                                                |
...
| destination    | [Postal Address](/specification/shopping/order/#postal-address) | **Yes**  | Delivery destination address.                                                                               |
...
| Name | Type                                      | Required | Description |
| ---- | ----------------------------------------- | -------- | ----------- |
| ucp  | [Ucp](/specification/shopping/order/#ucp) | **Yes**  |             |
...
| capabilities | Array\[[Capability Response](/specification/shopping/order/#capability-response)\] | **Yes**  | Active capabilities for this response.     |
