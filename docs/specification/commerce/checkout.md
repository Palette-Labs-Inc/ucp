...
{{ schema_fields('checkout_resp', 'commerce/checkout') }}
...
{{ method_fields('create_checkout', 'commerce/rest.openapi.json', 'commerce/checkout') }}
...
{{ method_fields('get_checkout', 'commerce/rest.openapi.json', 'commerce/checkout') }}
...
{{ method_fields('update_checkout', 'commerce/rest.openapi.json', 'commerce/checkout') }}
...
{{ method_fields('complete_checkout', 'commerce/rest.openapi.json', 'commerce/checkout') }}
...
{{ method_fields('cancel_checkout', 'commerce/rest.openapi.json', 'commerce/checkout') }}
...
{{ schema_fields('buyer', 'commerce/checkout') }}

### Fulfillment Option

{{ extension_schema_fields('fulfillment_resp.json#/$defs/fulfillment_option', 'commerce/checkout') }}

### Item

#### Item Create Request

{{ schema_fields('types/item.create_req', 'commerce/checkout') }}

#### Item Update Request

{{ schema_fields('types/item.update_req', 'commerce/checkout') }}

#### Item Response

{{ schema_fields('types/item_resp', 'commerce/checkout') }}

### Line Item

#### Line Item Create Request

{{ schema_fields('types/line_item.create_req', 'commerce/checkout') }}

#### Line Item Update Request

{{ schema_fields('types/line_item.update_req', 'commerce/checkout') }}

#### Line Item Response

{{ schema_fields('types/line_item_resp', 'commerce/checkout') }}

### Link

{{ schema_fields('types/link', 'commerce/checkout') }}
...
{{ schema_fields('message', 'commerce/checkout') }}

### Message Error

{{ schema_fields('types/message_error', 'commerce/checkout') }}

### Message Info

{{ schema_fields('types/message_info', 'commerce/checkout') }}

### Message Warning

{{ schema_fields('types/message_warning', 'commerce/checkout') }}

### Payment

#### Payment Create Request

{{ schema_fields('payment.create_req', 'commerce/checkout') }}

#### Payment Update Request

{{ schema_fields('payment.update_req', 'commerce/checkout') }}

#### Payment Response

{{ schema_fields('payment_resp', 'commerce/checkout') }}

### Payment Handler Response

{{ schema_fields('types/payment_handler_resp', 'commerce/checkout') }}

### Payment Instrument

{{ schema_fields('payment_instrument', 'commerce/checkout') }}

### Card Payment Instrument

{{ schema_fields('card_payment_instrument', 'commerce/checkout') }}

### Payment Credential

{{ schema_fields('payment_credential', 'commerce/checkout') }}

### Token Credential Response

{{ schema_fields('token_credential.create_req', 'commerce/checkout') }}

### Card Credential

{{ schema_fields('card_credential', 'commerce/checkout') }}

### Postal Address

{{ schema_fields('postal_address', 'commerce/checkout') }}

### Response

{{ extension_schema_fields('capability.json#/$defs/response', 'commerce/checkout') }}

### Total

#### Total Response

{{ schema_fields('types/total_resp', 'commerce/checkout') }}

### UCP Response Checkout

{{ extension_schema_fields('ucp.json#/$defs/response_checkout', 'commerce/checkout') }}

### Order Confirmation

{{ schema_fields('order_confirmation', 'commerce/checkout') }}
