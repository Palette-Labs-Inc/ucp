...
export class DiscoveryService {
  ...
  constructor(args: { ucpVersion: string; endpointOrigin: string }) {
    this.ucpVersion = args.ucpVersion;
    this.endpointOrigin = args.endpointOrigin;
  }
  ...
  getMerchantProfile = (c: Context) => {
    const discoveryProfile: UcpDiscoveryProfile =
      UcpDiscoveryProfileSchema.parse({
        ucp: {
